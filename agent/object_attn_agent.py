...
class ObjectAttnAgentEncoder(Encoder):
...
class ObjectAttnAgentDecoder(MlpDecoder):
    pass

class ObjectAttnAgent(SampleFactoryAgent):
    def encoder_cls(self):
        return ObjectAttnAgentEncoder

    def decoder_cls(self):
        return ObjectAttnAgentDecoder
