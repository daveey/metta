...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "depends": [
            "puffergrid/event.hpp"
        ],
        "include_dirs": [
            "puffergrid"
        ],
        "language": "c++",
        "name": "puffergrid.event",
        "sources": [
            "puffergrid/event.pyx"
        ]
    },
    "module_name": "puffergrid.event"
}
END: Cython Metadata */
...
#define __PYX_HAVE__puffergrid__event
#define __PYX_HAVE_API__puffergrid__event
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from "puffergrid.event" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "puffergrid.event"
extern int __pyx_module_is_main_puffergrid__event;
int __pyx_module_is_main_puffergrid__event = 0;

/* Implementation of "puffergrid.event" */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_puffergrid__event) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "puffergrid.event")) {
      if (unlikely((PyDict_SetItemString(modules, "puffergrid.event", __pyx_m) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init puffergrid.event", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init puffergrid.event");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
